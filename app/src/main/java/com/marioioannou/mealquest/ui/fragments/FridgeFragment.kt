...
import com.marioioannou.mealquest.adapters.IngredientsAdapter
...
class FridgeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.readIngredientsName().observe(viewLifecycleOwner, Observer {name ->
            val applyQueriesName = applyQueries(name)
        ...
        val itemTouchHelperCallback = object : ItemTouchHelper.SimpleCallback(
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                Snackbar.make(view, "$ingredientName successfully deleted.", Snackbar. LENGTH_SHORT).apply {
                    setAction("Undo") {
        ...
        binding.fabFridgeSearch.setOnClickListener {
            val action = FridgeFragmentDirections.actionFridgeFragmentToRecipesByIngredientsFragment(ingredientNames)
